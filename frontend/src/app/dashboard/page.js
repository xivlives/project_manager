...
const Dashboard = () => {
  ...
  const calculateStats = (projects, tasks) => {
    ...
    const quickestTask = tasks.reduce((fastest, current) => {
      ...
      return current.completion_time < fastest.completion_time
        ? current
        : fastest;
    }, null);
  ...
  return (
    <div className="p-6 ml-64 h-fit">
      <h1 className="text-3xl text-center font-bold text-slate-400 mb-8">
        Dashboard
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard
          ...
          subtitle={`Completed in ${
            stats.quickestTask?.completion_time || 0
          } days`}
        />
      </div>
